...
public class BlackjackClient {
    ...
    private static final String USERNAME = "grwaqo"; // replace with your username
    private static final String PASSWORD = "ebaac79"; // replace with your from the file posted to Classroom
